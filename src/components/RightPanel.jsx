    ...
    <aside className="w-80 2xl:w-96 bg-white border-l border-gray-100 flex flex-col h-full sticky top-0 shrink-0">
      <div className="p-5 flex-1 overflow-y-auto sidebar-nav">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-1.5 py-2 mb-5 rounded-xl text-xs font-semibold hover:opacity-90 transition"
        ...
        <div className="mb-4 rounded-2xl overflow-hidden" style={{ border: '1px solid rgba(92,46,212,0.1)', background: 'linear-gradient(135deg, #F8F6FF 0%, #F0F9F7 100%)' }}>
          <div className="px-4 pt-4 pb-3">
            <h3 className="text-base font-bold text-navy leading-tight mb-3">Get a quote in seconds!</h3>
            ...
            <div
              ...
              className={`cursor-pointer transition-all ${dragging ? 'opacity-80' : ''}`}
            >
              ...
              <button
                ...
                style={{ background: 'linear-gradient(88.09deg, #5C2ED4 0.11%, #A614C3 63.8%)', boxShadow: '0 3px 12px rgba(92,46,212,0.25)' }}
              >
                Upload Here
              </button>
            </div>
            <p className="text-[10px] text-gray-400 text-center mt-2">PDF, JPG, PNG · Max 10MB</p>
          </div>
        </div>
