...
function SectionHeader({ title }) {
  return (
    <div
      ...
      style={{ background: 'linear-gradient(88deg, #5C2ED4 0%, #A614C3 100%)' }}
    >
      <h3 className="text-[10px] font-bold text-white tracking-widest uppercase">{title}</h3>
    </div>
  )
}
      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-6 pb-5" style={{ borderBottom: '2px solid #F3F4F6' }}>
          ...
          <div className="text-center">
            <p className="text-[10px] font-bold tracking-widest uppercase" style={{ color: '#9CA3AF' }}>Commercial Auto Application</p>
            <p className="text-[10px] mt-0.5" style={{ color: '#C4B5D4' }}>Submission #CA0094894 · {today}</p>
          </div>
